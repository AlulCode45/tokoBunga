                ...
                <div class="col-md-6 col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-horizontal" method="POST" action="<?= base_url('admin/discount/save')?>">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 form-group mb-2">
                                                <input type="number" id="percent" class="form-control" name="percent" placeholder="Category percent" min="0" max="100" maxlength="3">
                                            </div>
